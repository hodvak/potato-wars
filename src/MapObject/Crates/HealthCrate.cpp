...
HealthCrate::HealthCrate(const MapVector &pos,
        ...
        Crate(pos,
              resources_manager::getTexture("resources/images/Textures/health2.png"),
              sf::IntRect(0, 
                          0,
                          resources_manager::getTexture("resources/images/Textures/health2.png")->getSize().x,
                          resources_manager::getTexture("resources/images/Textures/health2.png")->getSize().y),
                          map,
                          bombHandler),
